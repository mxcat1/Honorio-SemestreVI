...
public static b4a.example.appprincipal _appprincipal = null;
  public Object[] GetGlobals() {
		return new Object[] {"appPrincipal",Debug.moduleToString(b4a.example.appprincipal.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service};
}
}