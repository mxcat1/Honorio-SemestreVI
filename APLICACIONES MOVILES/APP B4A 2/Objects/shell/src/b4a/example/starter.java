...
public static b4a.example.appusuario _appusuario = null;
  public Object[] GetGlobals() {
		return new Object[] {"appregistrar",Debug.moduleToString(b4a.example.appregistrar.class),"appusuario",Debug.moduleToString(b4a.example.appusuario.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service};
}
}